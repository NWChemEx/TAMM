...
#
#   GIT_ONLY_TRACK_DIRS (OPTIONAL)
#   -- Only track specified directories. This is empty by default.
#
# DESIGN
...
function(GetGitState _working_dir)
    ...
    RunGitCommand(status --porcelain ${untracked_flag} ${GIT_ONLY_TRACK_DIRS})
    if(NOT exit_code EQUAL 0)
        set(ENV{GIT_IS_DIRTY} "false")
    else()
        if(NOT "${output}" STREQUAL "")
            set(ENV{GIT_IS_DIRTY} "true")
            set(ENV{GIT_STATUS} ${output})
            RunGitCommand(diff -U0 ${GIT_ONLY_TRACK_DIRS})
            set(ENV{GIT_DIFF_MINIMAL} "${output}")
        else()
            set(ENV{GIT_IS_DIRTY} "false")
        endif()
    endif()
...
function(SetupGitMonitoring)
    add_custom_target(check_git
        ...
        COMMAND
            ...
            -DGIT_ONLY_TRACK_DIRS=${GIT_ONLY_TRACK_DIRS}
