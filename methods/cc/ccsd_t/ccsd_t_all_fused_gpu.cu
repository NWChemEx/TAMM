...
void fully_fused_ccsd_t_gpu(cudaStream_t* stream_id, size_t num_blocks, size_t base_size_h1b,
  ...
  // printf ("[old] s1: %d,%d,%d/%d,%d,%d/%d,%d,%d\n", host_s1_exec[0], host_s1_exec[1],
  // host_s1_exec[2], host_s1_exec[3], host_s1_exec[4], host_s1_exec[5], host_s1_exec[6],
  // host_s1_exec[7], host_s1_exec[8]); for (int i = 0; i < (int)size_noab; i++) {
