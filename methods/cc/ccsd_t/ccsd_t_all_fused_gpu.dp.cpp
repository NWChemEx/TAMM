...
//
dpct::constant_memory<int, 1> const_df_s1_size(6);
dpct::constant_memory<int, 1> const_df_s1_exec(9);
dpct::constant_memory<int, 1> const_df_d1_size(7 * MAX_NOAB);
dpct::constant_memory<int, 1> const_df_d1_exec(9 * MAX_NOAB);
dpct::constant_memory<int, 1> const_df_d2_size(7 * MAX_NVAB);
dpct::constant_memory<int, 1> const_df_d2_exec(9 * MAX_NVAB);
...
void revised_jk_ccsd_t_fully_fused_kernel(int size_noab, int size_nvab, 
                                          ...
                                          int *const_df_s1_size,
                                          int *const_df_s1_exec,
                                          int *const_df_d1_size,
                                          int *const_df_d1_exec,
                                          int *const_df_d2_size,
                                          int *const_df_d2_exec,
                                          dpct::accessor<double, dpct::local, 2> sm_a,
                                          dpct::accessor<double, dpct::local, 2> sm_b)
{
  // For Shared Memory,
  ...
  int idx_h3 = item_ct1.get_local_id(2) % FUSION_SIZE_SLICE_1_H3;
  int idx_h2 = item_ct1.get_local_id(2) / FUSION_SIZE_SLICE_1_H3;
  int idx_p6 = item_ct1.get_local_id(1) % FUSION_SIZE_SLICE_1_P6;
  int idx_h1 = item_ct1.get_local_id(1) / FUSION_SIZE_SLICE_1_P6;
  ...
  int blk_idx_h3b = item_ct1.get_group(2) % (num_blks_h3b);
  ...
  for (int iter_noab = 0; iter_noab < size_noab; iter_noab++)
    {
      ...
      // 	(2) blk_idx_h/p*b
      blk_idx_p4b =
        item_ct1.get_group(2) / (num_blks_h3b * num_blks_h2b * num_blks_h1b *
      ...
      blk_idx_h3b = item_ct1.get_group(2) % (num_blks_h3b);
...
#pragma unroll 1
          for (int l = 0; l < base_size_h7b; l+= FUSION_SIZE_INT_UNIT)
          {
              ...
              if (idx_p6 < rng_p4 && idx_h1 < rng_h1 &&
                  item_ct1.get_local_id(2) < FUSION_SIZE_INT_UNIT - internal_upperbound)
                for (int ll = 0; ll < rng_p5; ll++)
                {
                  sm_a[item_ct1.get_local_id(2)]
                    [item_ct1.get_local_id(1) + ll * FUSION_SIZE_TB_2_Y] =
                    tmp_dev_d1_t2[(str_blk_idx_p4 + idx_p6 +
                                   (str_blk_idx_p5 + ll +
                                    (str_blk_idx_h1 + idx_h1) * base_size_p5b) *
                                   base_size_p4b) *
                                  base_size_h7b +
                                  (item_ct1.get_local_id(2) + l)];
                }

              // Load Input Tensor to Shared Memory
              if (idx_h3 < rng_h3 && idx_h2 < rng_h2 &&
                  item_ct1.get_local_id(1) < FUSION_SIZE_INT_UNIT - internal_upperbound) {
                for (int ll = 0; ll < rng_p6; ll++)
                {
                  sm_b[item_ct1.get_local_id(1)]
                    [item_ct1.get_local_id(2) + ll * FUSION_SIZE_TB_2_X] =
                    tmp_dev_d1_v2[str_blk_idx_h3 + idx_h3 +
                                  (str_blk_idx_h2 + idx_h2 +
                                   (str_blk_idx_p6 + ll +
                                    (item_ct1.get_local_id(1) + l) * base_size_p6b) *
                                   base_size_h2b) *
                                  base_size_h3b];
                }
              }
...
#pragma unroll 1
  ...
  //
  {
    if (item_ct1.get_local_id(1) < 4) // 0, 1, 2, 3
      {
        // sm_a[16][64] <-- (4 x 16) x (4 x 4) = (16 x 64)		  'y''x'
        sm_a[0 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2)] =
          reg_tile[0][0];
        sm_a[1 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2)] =
          reg_tile[1][0];
        sm_a[2 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2)] =
          reg_tile[2][0];
        sm_a[3 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2)] =
          reg_tile[3][0];

        sm_a[0 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[0][1];
        sm_a[1 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[1][1];
        sm_a[2 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[2][1];
        sm_a[3 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[3][1];

        sm_a[0 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[0][2];
        sm_a[1 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[1][2];
        sm_a[2 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[2][2];
        sm_a[3 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[3][2];

        sm_a[0 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[0][3];
        sm_a[1 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[1][3];
        sm_a[2 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[2][3];
        sm_a[3 + item_ct1.get_local_id(1) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[3][3];
      }

    if (item_ct1.get_local_id(1) >= 4 &&
        item_ct1.get_local_id(1) < 8) // 4, 5, 6, 7
      {
        sm_b[0 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2)] =
          reg_tile[0][0];
        sm_b[1 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2)] =
          reg_tile[1][0];
        sm_b[2 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2)] =
          reg_tile[2][0];
        sm_b[3 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2)] =
          reg_tile[3][0];

        sm_b[0 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[0][1];
        sm_b[1 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[1][1];
        sm_b[2 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[2][1];
        sm_b[3 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[3][1];

        sm_b[0 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[0][2];
        sm_b[1 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[1][2];
        sm_b[2 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[2][2];
        sm_b[3 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[3][2];

        sm_b[0 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[0][3];
        sm_b[1 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[1][3];
        sm_b[2 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[2][3];
        sm_b[3 + (item_ct1.get_local_id(1) - 4) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[3][3];
      }
    item_ct1.barrier();
    ...
    if (item_ct1.get_local_id(1) < 4) // 0, 1, 2, 3
      {
        reg_tile[0][0] = sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2))];
        reg_tile[1][0] = sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2))];
        reg_tile[2][0] = sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2))];
        reg_tile[3][0] = sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2))];

        reg_tile[0][1] = sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2)) + 16];
        reg_tile[1][1] = sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2)) + 16];
        reg_tile[2][1] = sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2)) + 16];
        reg_tile[3][1] = sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2)) + 16];

        reg_tile[0][2] = sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2)) + 32];
        reg_tile[1][2] = sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2)) + 32];
        reg_tile[2][2] = sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2)) + 32];
        reg_tile[3][2] = sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2)) + 32];

        reg_tile[0][3] = sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2)) + 48];
        reg_tile[1][3] = sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2)) + 48];
        reg_tile[2][3] = sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2)) + 48];
        reg_tile[3][3] = sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2)) + 48];
      }

    if (item_ct1.get_local_id(1) >= 4 &&
        item_ct1.get_local_id(1) < 8) // 4, 5, 6, 7
      {
        reg_tile[0][0] = sm_b[(item_ct1.get_local_id(1) - 4) + 0][(item_ct1.get_local_id(2))];
        reg_tile[1][0] = sm_b[(item_ct1.get_local_id(1) - 4) + 4][(item_ct1.get_local_id(2))];
        reg_tile[2][0] = sm_b[(item_ct1.get_local_id(1) - 4) + 8][(item_ct1.get_local_id(2))];
        reg_tile[3][0] = sm_b[(item_ct1.get_local_id(1) - 4) + 12][(item_ct1.get_local_id(2))];

        reg_tile[0][1] = sm_b[(item_ct1.get_local_id(1) - 4) + 0]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[1][1] = sm_b[(item_ct1.get_local_id(1) - 4) + 4]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[2][1] = sm_b[(item_ct1.get_local_id(1) - 4) + 8]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[3][1] = sm_b[(item_ct1.get_local_id(1) - 4) + 12]
          [(item_ct1.get_local_id(2)) + 16];

        reg_tile[0][2] = sm_b[(item_ct1.get_local_id(1) - 4) + 0]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[1][2] = sm_b[(item_ct1.get_local_id(1) - 4) + 4]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[2][2] = sm_b[(item_ct1.get_local_id(1) - 4) + 8]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[3][2] = sm_b[(item_ct1.get_local_id(1) - 4) + 12]
          [(item_ct1.get_local_id(2)) + 32];

        reg_tile[0][3] = sm_b[(item_ct1.get_local_id(1) - 4) + 0]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[1][3] = sm_b[(item_ct1.get_local_id(1) - 4) + 4]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[2][3] = sm_b[(item_ct1.get_local_id(1) - 4) + 8]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[3][3] = sm_b[(item_ct1.get_local_id(1) - 4) + 12]
          [(item_ct1.get_local_id(2)) + 48];
      }
    item_ct1.barrier();

    if (item_ct1.get_local_id(1) >= 8 &&
        item_ct1.get_local_id(1) < 12) // 8, 9, 10, 11
      {
        sm_a[0 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2)] =
          reg_tile[0][0];
        sm_a[1 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2)] =
          reg_tile[1][0];
        sm_a[2 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2)] =
          reg_tile[2][0];
        sm_a[3 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2)] =
          reg_tile[3][0];

        sm_a[0 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[0][1];
        sm_a[1 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[1][1];
        sm_a[2 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[2][1];
        sm_a[3 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 16] =
          reg_tile[3][1];

        sm_a[0 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[0][2];
        sm_a[1 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[1][2];
        sm_a[2 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[2][2];
        sm_a[3 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 32] =
          reg_tile[3][2];

        sm_a[0 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[0][3];
        sm_a[1 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[1][3];
        sm_a[2 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[2][3];
        sm_a[3 + (item_ct1.get_local_id(1) - 8) * 4][item_ct1.get_local_id(2) + 48] =
          reg_tile[3][3];
      }

    if (item_ct1.get_local_id(1) >= 12) // 12, 13, 14, 15
      {
        sm_b[0 + (item_ct1.get_local_id(1) - 12) * 4][item_ct1.get_local_id(2)] =
          reg_tile[0][0];
        sm_b[1 + (item_ct1.get_local_id(1) - 12) * 4][item_ct1.get_local_id(2)] =
          reg_tile[1][0];
        sm_b[2 + (item_ct1.get_local_id(1) - 12) * 4][item_ct1.get_local_id(2)] =
          reg_tile[2][0];
        sm_b[3 + (item_ct1.get_local_id(1) - 12) * 4][item_ct1.get_local_id(2)] =
          reg_tile[3][0];

        sm_b[0 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 16] = reg_tile[0][1];
        sm_b[1 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 16] = reg_tile[1][1];
        sm_b[2 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 16] = reg_tile[2][1];
        sm_b[3 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 16] = reg_tile[3][1];

        sm_b[0 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 32] = reg_tile[0][2];
        sm_b[1 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 32] = reg_tile[1][2];
        sm_b[2 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 32] = reg_tile[2][2];
        sm_b[3 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 32] = reg_tile[3][2];

        sm_b[0 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 48] = reg_tile[0][3];
        sm_b[1 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 48] = reg_tile[1][3];
        sm_b[2 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 48] = reg_tile[2][3];
        sm_b[3 + (item_ct1.get_local_id(1) - 12) * 4]
          [item_ct1.get_local_id(2) + 48] = reg_tile[3][3];
      }
    item_ct1.barrier();
    ...
    if (item_ct1.get_local_id(1) >= 8 &&
      ...
      {
        reg_tile[0][0] =
          sm_a[(item_ct1.get_local_id(1) - 8) + 0][(item_ct1.get_local_id(2))];
        reg_tile[1][0] =
          sm_a[(item_ct1.get_local_id(1) - 8) + 4][(item_ct1.get_local_id(2))];
        reg_tile[2][0] =
          sm_a[(item_ct1.get_local_id(1) - 8) + 8][(item_ct1.get_local_id(2))];
        reg_tile[3][0] =
          sm_a[(item_ct1.get_local_id(1) - 8) + 12][(item_ct1.get_local_id(2))];

        reg_tile[0][1] = sm_a[(item_ct1.get_local_id(1) - 8) + 0]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[1][1] = sm_a[(item_ct1.get_local_id(1) - 8) + 4]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[2][1] = sm_a[(item_ct1.get_local_id(1) - 8) + 8]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[3][1] = sm_a[(item_ct1.get_local_id(1) - 8) + 12]
          [(item_ct1.get_local_id(2)) + 16];

        reg_tile[0][2] = sm_a[(item_ct1.get_local_id(1) - 8) + 0]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[1][2] = sm_a[(item_ct1.get_local_id(1) - 8) + 4]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[2][2] = sm_a[(item_ct1.get_local_id(1) - 8) + 8]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[3][2] = sm_a[(item_ct1.get_local_id(1) - 8) + 12]
          [(item_ct1.get_local_id(2)) + 32];

        reg_tile[0][3] = sm_a[(item_ct1.get_local_id(1) - 8) + 0]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[1][3] = sm_a[(item_ct1.get_local_id(1) - 8) + 4]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[2][3] = sm_a[(item_ct1.get_local_id(1) - 8) + 8]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[3][3] = sm_a[(item_ct1.get_local_id(1) - 8) + 12]
          [(item_ct1.get_local_id(2)) + 48];
      }
    ...
    if (item_ct1.get_local_id(1) >= 12) // 12, 13, 14, 15
      {
        reg_tile[0][0] =
          sm_b[(item_ct1.get_local_id(1) - 12) + 0][(item_ct1.get_local_id(2))];
        reg_tile[1][0] =
          sm_b[(item_ct1.get_local_id(1) - 12) + 4][(item_ct1.get_local_id(2))];
        reg_tile[2][0] =
          sm_b[(item_ct1.get_local_id(1) - 12) + 8][(item_ct1.get_local_id(2))];
        reg_tile[3][0] =
          sm_b[(item_ct1.get_local_id(1) - 12) + 12][(item_ct1.get_local_id(2))];

        reg_tile[0][1] = sm_b[(item_ct1.get_local_id(1) - 12) + 0]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[1][1] = sm_b[(item_ct1.get_local_id(1) - 12) + 4]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[2][1] = sm_b[(item_ct1.get_local_id(1) - 12) + 8]
          [(item_ct1.get_local_id(2)) + 16];
        reg_tile[3][1] = sm_b[(item_ct1.get_local_id(1) - 12) + 12]
          [(item_ct1.get_local_id(2)) + 16];

        reg_tile[0][2] = sm_b[(item_ct1.get_local_id(1) - 12) + 0]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[1][2] = sm_b[(item_ct1.get_local_id(1) - 12) + 4]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[2][2] = sm_b[(item_ct1.get_local_id(1) - 12) + 8]
          [(item_ct1.get_local_id(2)) + 32];
        reg_tile[3][2] = sm_b[(item_ct1.get_local_id(1) - 12) + 12]
          [(item_ct1.get_local_id(2)) + 32];

        reg_tile[0][3] = sm_b[(item_ct1.get_local_id(1) - 12) + 0]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[1][3] = sm_b[(item_ct1.get_local_id(1) - 12) + 4]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[2][3] = sm_b[(item_ct1.get_local_id(1) - 12) + 8]
          [(item_ct1.get_local_id(2)) + 48];
        reg_tile[3][3] = sm_b[(item_ct1.get_local_id(1) - 12) + 12]
          [(item_ct1.get_local_id(2)) + 48];
      }
    item_ct1.barrier();
  }
          ...
          for (int l = 0; l < base_size_h7b; l+= FUSION_SIZE_INT_UNIT)
            {
              ...
              if (idx_p6 < rng_p6 && idx_h1 < rng_h1 &&
                ...
                for (int ll = 0; ll < rng_p5; ll++)
                  {
                    sm_a[item_ct1.get_local_id(2)]
                      [item_ct1.get_local_id(1) + ll * FUSION_SIZE_TB_1_Y] =
              ...
              if (idx_h3 < rng_h3 && idx_h2 < rng_h2 &&
                ...
                for (int ll = 0; ll < rng_p4; ll++)
                  {
                    sm_b[item_ct1.get_local_id(1)][item_ct1.get_local_id(2) +
                                                   ll * FUSION_SIZE_TB_1_X] =
                      tmp_dev_d1_v2_4[(str_blk_idx_h3 + idx_h3 +
                                       (str_blk_idx_h2 + idx_h2 +
                                        (str_blk_idx_p4 + ll +
                                         (item_ct1.get_local_id(1) + l) * base_size_p4b) *
                                        base_size_h2b) *
                                       base_size_h3b)];
                  }
              item_ct1.barrier();
                ...
                for (int ll = 0; ll < rng_p5; ll++)
                  {
                    sm_b[item_ct1.get_local_id(1)][item_ct1.get_local_id(2) +
                      ...
                      tmp_dev_d1_v2_7[(str_blk_idx_h3 + idx_h3 +
                                       (str_blk_idx_h2 + idx_h2 +
                                        (str_blk_idx_p5 + ll +
                                         (item_ct1.get_local_id(1) + l) * base_size_p5b) *
                                        base_size_h2b) *
                                       base_size_h3b)];
                  }
              item_ct1.barrier();
...
#pragma unroll 1
  ...
  if (item_ct1.get_local_id(2) == 0 && item_ct1.get_local_id(1) % 2 == 0)
    {
      sm_a[0][item_ct1.get_local_id(1) / 2] = energy_1;
      sm_b[0][item_ct1.get_local_id(1) / 2] = energy_2;
    }
  item_ct1.barrier();
  ...
  if (item_ct1.get_local_id(2) == 0 && item_ct1.get_local_id(1) == 0)
    {
      ...
      reduced_energy[item_ct1.get_group(2)] = final_energy_1;
      reduced_energy[item_ct1.get_group(2) + item_ct1.get_group_range(2)] =
        final_energy_2;
    }
}
...
void fully_fused_ccsd_t_gpu(sycl::queue **stream_id, size_t num_blocks, size_t base_size_h1b,
                            ...
                            double factor,
                            //
                            double *dev_evl_sorted_h1b, double *dev_evl_sorted_h2b,
                            double *dev_evl_sorted_h3b, double *dev_evl_sorted_p4b,
                            double *dev_evl_sorted_p5b, double *dev_evl_sorted_p6b,
                            double *partial_energies)
{
  // 	
  // 	to handle constant memories
  //
  *stream_id->memcpy(const_df_s1_size.get_ptr(), host_s1_size,
                     sizeof(int) * (6));
  *stream_id->memcpy(const_df_s1_exec.get_ptr(), host_s1_exec,
                     sizeof(int) * (9));

  *stream_id->memcpy(const_df_d1_size.get_ptr(), host_d1_size,
                     sizeof(int) * (7 * size_noab));
  *stream_id->memcpy(const_df_d1_exec.get_ptr(), host_d1_exec,
                     sizeof(int) * (9 * size_noab));

  *stream_id->memcpy(const_df_d2_size.get_ptr(), host_d2_size,
                     sizeof(int) * (7 * size_nvab));
  *stream_id->memcpy(const_df_d2_exec.get_ptr(), host_d2_exec,
                     sizeof(int) * (9 * size_nvab));

  // 
  // 	Depends on # of Fused Kernel
  //
  sycl::range<3> gridsize_1(num_blocks, 1, 1);
  sycl::range<3> blocksize_1(FUSION_SIZE_TB_1_X, FUSION_SIZE_TB_1_Y, 1);
  ...
  (*stream_id)->submit([&](sycl::handler &cgh) {
                         sycl::range<2> sm_a_range_ct1(16, 65 /*64 + 1*/);
                         sycl::range<2> sm_b_range_ct1(16, 65 /*64 + 1*/);

                         auto const_df_s1_size_ptr_ct1 = const_df_s1_size.get_ptr();
                         auto const_df_s1_exec_ptr_ct1 = const_df_s1_exec.get_ptr();
                         auto const_df_d1_size_ptr_ct1 = const_df_d1_size.get_ptr();
                         auto const_df_d1_exec_ptr_ct1 = const_df_d1_exec.get_ptr();
                         auto const_df_d2_size_ptr_ct1 = const_df_d2_size.get_ptr();
                         auto const_df_d2_exec_ptr_ct1 = const_df_d2_exec.get_ptr();

                         sycl::accessor<double, 2, sycl::access::mode::read_write,
                                        sycl::access::target::local>
                           sm_a_acc_ct1(sm_a_range_ct1, cgh);
                         sycl::accessor<double, 2, sycl::access::mode::read_write,
                                        sycl::access::target::local>
                           sm_b_acc_ct1(sm_b_range_ct1, cgh);

                         auto dpct_global_range = gridsize_1 * blocksize_1;

                         cgh.parallel_for(
                                          sycl::nd_range<3>(sycl::range<3>(dpct_global_range.get(2),
                                                                           dpct_global_range.get(1),
                                                                           dpct_global_range.get(0)),
                                                            sycl::range<3>(blocksize_1.get(2), blocksize_1.get(1),
                                                                           blocksize_1.get(0))),
                                          [=](sycl::nd_item<3> item_ct1) {
                                            revised_jk_ccsd_t_fully_fused_kernel(
                                                                                 (int)size_noab, (int)size_nvab, (int)size_max_dim_s1_t1,
                                                                                 (int)size_max_dim_s1_v2, (int)size_max_dim_d1_t2,
                                                                                 (int)size_max_dim_d1_v2, (int)size_max_dim_d2_t2,
                                                                                 (int)size_max_dim_d2_v2, df_dev_d1_t2_all, df_dev_d1_v2_all,
                                                                                 df_dev_d2_t2_all, df_dev_d2_v2_all, df_dev_s1_t1_all,
                                                                                 df_dev_s1_v2_all, dev_evl_sorted_h1b, dev_evl_sorted_h2b,
                                                                                 dev_evl_sorted_h3b, dev_evl_sorted_p4b, dev_evl_sorted_p5b,
                                                                                 dev_evl_sorted_p6b, partial_energies,
                                                                                 ...
                                                                                 cl::sycl::ceil(base_size_p4b, FUSION_SIZE_SLICE_1_P4), (int)base_size_h1b,
                                                                                 (int)base_size_h2b, (int)base_size_h3b, (int)base_size_p4b,
                                                                                 (int)base_size_p5b, (int)base_size_p6b, item_ct1,
                                                                                 const_df_s1_size_ptr_ct1, const_df_s1_exec_ptr_ct1,
                                                                                 const_df_d1_size_ptr_ct1, const_df_d1_exec_ptr_ct1,
                                                                                 const_df_d2_size_ptr_ct1, const_df_d2_exec_ptr_ct1,
                                                                                 dpct::accessor<double, dpct::local, 2>(sm_a_acc_ct1, sm_a_range_ct1),
                                                                                 dpct::accessor<double, dpct::local, 2>(sm_b_acc_ct1,
                                                                                                                        sm_b_range_ct1));
                                          });
                       });
}
...
#pragma unroll 1
  ...
  //
  {
    ...
    if (item_ct1.get_local_id(1) < 4) // 0, 1, 2, 3
      {
        reg_tile[0][0] =
          sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2))];
        reg_tile[1][0] =
          sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2))];
        reg_tile[2][0] =
          sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2))];
        reg_tile[3][0] =
          sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2))];

        reg_tile[0][1] =
          sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2)) + 16];
        reg_tile[1][1] =
          sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2)) + 16];
        reg_tile[2][1] =
          sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2)) + 16];
        reg_tile[3][1] =
          sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2)) + 16];

        reg_tile[0][2] =
          sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2)) + 32];
        reg_tile[1][2] =
          sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2)) + 32];
        reg_tile[2][2] =
          sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2)) + 32];
        reg_tile[3][2] =
          sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2)) + 32];

        reg_tile[0][3] =
          sm_a[item_ct1.get_local_id(1) + 0][(item_ct1.get_local_id(2)) + 48];
        reg_tile[1][3] =
          sm_a[item_ct1.get_local_id(1) + 4][(item_ct1.get_local_id(2)) + 48];
        reg_tile[2][3] =
          sm_a[item_ct1.get_local_id(1) + 8][(item_ct1.get_local_id(2)) + 48];
        reg_tile[3][3] =
          sm_a[item_ct1.get_local_id(1) + 12][(item_ct1.get_local_id(2)) + 48];
      }
    ...
    if (item_ct1.get_local_id(1) >= 4 &&
      ...
      {
        reg_tile[0][0] =
          sm_b[(item_ct1.get_local_id(1) - 4) + 0][(item_ct1.get_local_id(2))];
        reg_tile[1][0] =
          sm_b[(item_ct1.get_local_id(1) - 4) + 4][(item_ct1.get_local_id(2))];
        reg_tile[2][0] =
          sm_b[(item_ct1.get_local_id(1) - 4) + 8][(item_ct1.get_local_id(2))];
        reg_tile[3][0] =
          sm_b[(item_ct1.get_local_id(1) - 4) + 12][(item_ct1.get_local_id(2))];
...
//
void total_fused_ccsd_t_gpu(sycl::queue **stream_id, int gpu_id, size_t base_size_h1b,
                            size_t base_size_h2b, size_t base_size_h3b, size_t base_size_p4b,
                            size_t base_size_p5b, size_t base_size_p6b,
                            //
                            double *host_d1_t2_all, double *host_d1_v2_all, double *host_d2_t2_all,
                            double *host_d2_v2_all, double *host_s1_t2_all, double *host_s1_v2_all,
                            //
                            size_t size_d1_t2_all, size_t size_d1_v2_all, size_t size_d2_t2_all,
                            size_t size_d2_v2_all, size_t size_s1_t2_all, size_t size_s1_v2_all,
                            //
                            int *list_d1_sizes, int *list_d2_sizes, int *list_s1_sizes,
                            //
                            std::vector<int> vec_d1_flags, std::vector<int> vec_d2_flags,
                            ...
                            //
                            double factor, double *host_evl_sorted_h1b, double *host_evl_sorted_h2b,
                            double *host_evl_sorted_h3b, double *host_evl_sorted_p4b,
                            double *host_evl_sorted_p5b, double *host_evl_sorted_p6b,
                            double *final_energy_4, double *final_energy_5)
{
  ...
  // 
  *stream_id->memcpy(dev_list_s1_flags_offset, vec_s1_flags.data(), sizeof(int) * (NUM_IA6_LOOPS * NUM_S1_EQUATIONS));
  *stream_id->memcpy(dev_list_d1_flags_offset, vec_d1_flags.data(), sizeof(int) * (NUM_IA6_LOOPS * NUM_D1_EQUATIONS * size_noab));
  *stream_id->memcpy(dev_list_d2_flags_offset, vec_d2_flags.data(), sizeof(int) * (NUM_IA6_LOOPS * NUM_D2_EQUATIONS * size_nvab));

  //
  *stream_id->memcpy(dev_list_s1_problem_size, list_s1_sizes, sizeof(int) * (NUM_IA6_LOOPS * NUM_S1_INDEX));
  *stream_id->memcpy(dev_list_d1_problem_size, list_d1_sizes, sizeof(int) * (NUM_IA6_LOOPS * NUM_D1_INDEX * size_noab));
  *stream_id->memcpy(dev_list_d2_problem_size, list_d2_sizes, sizeof(int) * (NUM_IA6_LOOPS * NUM_D2_INDEX * size_nvab));

  // 
  *stream_id->memcpy(dev_d1_t2_all, host_d1_t2_all, (size_d1_t2_all) * sizeof(double));
  *stream_id->memcpy(dev_d1_v2_all, host_d1_v2_all, (size_d1_v2_all) * sizeof(double));
  *stream_id->memcpy(dev_d2_t2_all, host_d2_t2_all, (size_d2_t2_all) * sizeof(double));
  *stream_id->memcpy(dev_d2_v2_all, host_d2_v2_all, (size_d2_v2_all) * sizeof(double));
  *stream_id->memcpy(dev_s1_t2_all, host_s1_t2_all, (size_s1_t2_all) * sizeof(double));
  *stream_id->memcpy(dev_s1_v2_all, host_s1_v2_all, (size_s1_v2_all) * sizeof(double));

  // 
  *stream_id->memcpy(dev_evl_sorted_h1b, host_evl_sorted_h1b, base_size_h1b * sizeof(double));
  *stream_id->memcpy(dev_evl_sorted_h2b, host_evl_sorted_h2b, base_size_h2b * sizeof(double));
  *stream_id->memcpy(dev_evl_sorted_h3b, host_evl_sorted_h3b, base_size_h3b * sizeof(double));
  *stream_id->memcpy(dev_evl_sorted_p4b, host_evl_sorted_p4b, base_size_p4b * sizeof(double));
  *stream_id->memcpy(dev_evl_sorted_p5b, host_evl_sorted_p5b, base_size_p5b * sizeof(double));
  *stream_id->memcpy(dev_evl_sorted_p6b, host_evl_sorted_p6b, base_size_p6b * sizeof(double));
  ...
  // 
  size_t num_blocks_kernel_1 = cl::sycl::ceil(base_size_h3b, FUSION_SIZE_SLICE_1_H3) * cl::sycl::ceil(base_size_h2b, FUSION_SIZE_SLICE_1_H2) * 
    cl::sycl::ceil(base_size_h1b, FUSION_SIZE_SLICE_1_H1) * cl::sycl::ceil(base_size_p6b, FUSION_SIZE_SLICE_1_P6) * 
    cl::sycl::ceil(base_size_p5b, FUSION_SIZE_SLICE_1_P5) * cl::sycl::ceil(base_size_p4b, FUSION_SIZE_SLICE_1_P4);
	
  // Depends on # of Fused Kernel
  sycl::range<3> gridsize_1(num_blocks_kernel_1, 1, 1);
  sycl::range<3> blocksize_1(FUSION_SIZE_TB_1_X, FUSION_SIZE_TB_1_Y, 1);
  ...
  (*stream_id)->submit([&](sycl::handler &cgh)
  {
    ...
    cgh.parallel_for(sycl::nd_range<3>(sycl::range<3>(dpct_global_range.get(2),
                                                      dpct_global_range.get(1),
                                                      dpct_global_range.get(0)),
                                       sycl::range<3>(blocksize_1.get(2),
                                                      blocksize_1.get(1),
                                                      blocksize_1.get(0))),
                     [=](sycl::nd_item<3> item_ct1)
                     {
                       jk_ccsd_t_fully_fused_kernel(
                                                    (int)size_noab, (int)size_nvab, (int)size_max_dim_s1_t2,
                                                    (int)size_max_dim_s1_v2, (int)size_max_dim_d1_t2,
                                                    (int)size_max_dim_d1_v2, (int)size_max_dim_d2_t2,
                                                    (int)size_max_dim_d2_v2, dev_list_s1_flags_offset,
                                                    dev_list_d1_flags_offset, dev_list_d2_flags_offset,
                                                    dev_list_s1_problem_size, dev_list_d1_problem_size,
                                                    dev_list_d2_problem_size, dev_d1_t2_all, dev_d1_v2_all,
                                                    dev_d2_t2_all, dev_d2_v2_all, dev_s1_t2_all, dev_s1_v2_all,
                                                    dev_evl_sorted_h1b, dev_evl_sorted_h2b, dev_evl_sorted_h3b,
                                                    dev_evl_sorted_p4b, dev_evl_sorted_p5b, dev_evl_sorted_p6b,
                                                    dev_energies, cl::sycl::ceil(base_size_h3b, FUSION_SIZE_SLICE_1_H3),
                                                    cl::sycl::ceil(base_size_h2b, FUSION_SIZE_SLICE_1_H2),
                                                    cl::sycl::ceil(base_size_h1b, FUSION_SIZE_SLICE_1_H1),
                                                    cl::sycl::ceil(base_size_p6b, FUSION_SIZE_SLICE_1_P6),
                                                    cl::sycl::ceil(base_size_p5b, FUSION_SIZE_SLICE_1_P5),
  ...
  //
  *stream_id->memcpy(host_energies, dev_energies, num_blocks_kernel_1 * NUM_ENERGIES * sizeof(double)));
