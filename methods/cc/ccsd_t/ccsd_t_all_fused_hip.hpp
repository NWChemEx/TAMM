...
void fully_fused_ccsd_t_gpu(hipStream_t* stream_id, size_t num_blocks, 
                            ...
                            double* partial_energies)
{
    ...
    hipLaunchKernelGGL(revised_jk_ccsd_t_fully_fused_kernel, dim3(gridsize_1), dim3(blocksize_1), 0, *stream_id, (int)size_noab, (int)size_nvab, 
		       // 
		       (int)size_max_dim_s1_t1, (int)size_max_dim_s1_v2,
		       (int)size_max_dim_d1_t2, (int)size_max_dim_d1_v2,
		       (int)size_max_dim_d2_t2, (int)size_max_dim_d2_v2,
