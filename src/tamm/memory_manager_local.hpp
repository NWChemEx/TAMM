...
public:
  MemoryRegionLocal(MemoryManagerLocal& mgr): MemoryRegionImpl<MemoryManagerLocal>(mgr) {}
...
public:
   ...
   */
  static MemoryManagerLocal* create_coll(ProcGroup pg) { return new MemoryManagerLocal{pg}; }
...
protected:
  explicit MemoryManagerLocal(ProcGroup pg): MemoryManager{pg, MemoryManagerKind::local} {
