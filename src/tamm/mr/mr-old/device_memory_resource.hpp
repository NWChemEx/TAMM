...
public:
   ...
   */
  void* allocate(std::size_t bytes, gpu_stream_view stream) {
   ...
   */
  void deallocate(void* ptr, std::size_t bytes, gpu_stream_view stream) {
...
private:
   ...
   * @return void* Pointer to the newly allocated memory
   */
  virtual void* do_allocate(std::size_t bytes, gpu_stream_view stream) = 0;
   ...
   * @param stream Stream on which to perform deallocation
   */
  virtual void do_deallocate(void* ptr, std::size_t bytes, gpu_stream_view stream) = 0;
