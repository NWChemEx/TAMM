...
enum class DistributionKind : uint8_t { invalid, nw, dense, simple_round_robin, view, unit_tile };
...
// ---------------------------------------------------------------------------
template<typename T>
constexpr ElementType tensor_element_type() noexcept {
  return ElementType::invalid;
}
template<>
constexpr ElementType tensor_element_type<double>() noexcept {
  return ElementType::double_precision;
}
template<>
constexpr ElementType tensor_element_type<float>() noexcept {
  return ElementType::single_precision;
}
template<>
constexpr ElementType tensor_element_type<std::complex<float>>() noexcept {
  return ElementType::single_complex;
}
template<>
constexpr ElementType tensor_element_type<std::complex<double>>() noexcept {
...
struct IndexVectorEqual {
  [[nodiscard]] bool operator()(const IndexVector& lhs, const IndexVector& rhs) const noexcept {
    return lhs == rhs;
  }
};
