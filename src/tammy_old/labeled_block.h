#ifndef TAMMY_LABELED_BLOCK_H_
#define TAMMY_LABELED_BLOCK_H_

#include "tammy/types.h"
#include "tammy/block.h"
#include "tammy/perm.h"
#include "tammy/label_map.h"
