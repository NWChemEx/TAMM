#ifndef TAMMY_LABELEDTENSOR_H_
#define TAMMY_LABELEDTENSOR_H_
...
addop_validate(const LabeledTensorType& ltc,
  ...
  validate_slicing(tc.dim_ranges(), ltc.label_);
  validate_slicing(ta.dim_ranges(), lta.label_);
...
multop_validate(const LabeledTensorType& ltc,
  ...
  validate_slicing(tc.dim_ranges(), ltc.label_);
  validate_slicing(ta.dim_ranges(), lta.label_);
  validate_slicing(tb.dim_ranges(), ltb.label_);
