...
void ccsd_1prdm_ph_1_(Integer *d_t_vo, Integer *k_t_vo_offset,Integer *d_i0, 
                      Integer *k_i0_offset);
void ccsd_1prdm_ph_2_(Integer *d_t_vvoo, Integer *k_t_vvoo_offset,Integer *d_y_ov, 
                      Integer *k_y_ov_offset,Integer *d_i0, Integer *k_i0_offset);
void ccsd_1prdm_ph_3_1_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_y_ov, 
                        Integer *k_y_ov_offset,Integer *d_ph_3_1, Integer *k_ph_3_1_offset);
void ccsd_1prdm_ph_3_2_(Integer *d_t_vvoo, Integer *k_t_vvoo_offset,Integer *d_y_oovv, 
                        Integer *k_y_oovv_offset,Integer *d_ph_3_1, Integer *k_ph_3_1_offset);
void ccsd_1prdm_ph_3_(Integer *d_t_vo, Integer *k_t_vo_offset,Integer *d_ph_3_1, 
                      Integer *k_ph_3_1_offset,Integer *d_i0, Integer *k_i0_offset);
void ccsd_1prdm_ph_4_1_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_y_oovv, 
                        Integer *k_y_oovv_offset,Integer *d_ph_4_1, Integer *k_ph_4_1_offset);
void ccsd_1prdm_ph_4_(Integer *d_t_vvoo, Integer *k_t_vvoo_offset, Integer *d_ph_4_1, 
                      Integer *k_ph_4_1_offset,Integer *d_i0, Integer *k_i0_offset);

void offset_ccsd_1prdm_ph_3_1_(Integer *l_ph_3_1_offset, Integer *k_ph_3_1_offset, 
                               Integer *size_ph_3_1);
void offset_ccsd_1prdm_ph_4_1_(Integer *l_ph_4_1_offset, Integer *k_ph_4_1_offset, 
                               Integer *size_ph_4_1);
}
