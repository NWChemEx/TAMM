...
extern "C" {
  void ccsd_t_vo_1_(Integer *d_f1, Integer *k_f1_offset, Integer *d_i0, Integer *k_i0_offset);
  void ccsd_t_vo_2_1_(Integer *d_f1, Integer *k_f1_offset, Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_2_2_1_(Integer *d_f1, Integer *k_f1_offset, Integer *d_i2, Integer *k_i2_offset);
  void ccsd_t_vo_2_2_2_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_v2, Integer *k_v2_offset,
                      Integer *d_i2, Integer *k_i2_offset);
  void ccsd_t_vo_2_2_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_i2, Integer *k_i2_offset,
                    Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_2_3_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_v2, Integer *k_v2_offset,
                    Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_2_4_(Integer *d_t_vvoo, Integer *k_t_vvoo_offset, Integer *d_v2, Integer *k_v2_offset,
                    Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_2_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_i1, Integer *k_i1_offset, 
                  Integer *d_i0, Integer *k_i0_offset);
  void ccsd_t_vo_3_1_(Integer *d_f1, Integer *k_f1_offset, Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_3_2_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_v2, Integer *k_v2_offset,
                    Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_3_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_i1, Integer *k_i1_offset, 
                  Integer *d_i0, Integer *k_i0_offset);
  void ccsd_t_vo_4_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_v2, Integer *k_v2_offset, 
                  Integer *d_i0, Integer *k_i0_offset);
  void ccsd_t_vo_5_1_(Integer *d_f1, Integer *k_f1_offset, Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_5_2_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_v2, Integer *k_v2_offset,
                    Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_5_(Integer *d_t_vvoo, Integer *k_t_vvoo_offset, Integer *d_i1, Integer *k_i1_offset, 
                  Integer *d_i0, Integer *k_i0_offset);
  void ccsd_t_vo_6_1_(Integer *d_v2, Integer *k_v2_offset, Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_6_2_(Integer *d_t_vo, Integer *k_t_vo_offset, Integer *d_v2, Integer *k_v2_offset,
                    Integer *d_i1, Integer *k_i1_offset);
  void ccsd_t_vo_6_(Integer *d_t_vvoo, Integer *k_t_vvoo_offset, Integer *d_i1, Integer *k_i1_offset, 
                  Integer *d_i0, Integer *k_i0_offset);
  void ccsd_t_vo_7_(Integer *d_t_vvoo, Integer *k_t_vvoo_offset, Integer *d_v2, Integer *k_v2_offset,
                  Integer *d_i0, Integer *k_i0_offset);

  void offset_ccsd_t_vo_2_1_(Integer *l_i1_offset, Integer *k_i1_offset, Integer *size_i1);
  void offset_ccsd_t_vo_2_2_1_(Integer *l_i2_offset, Integer *k_i2_offset, Integer *size_i2);
  void offset_ccsd_t_vo_3_1_(Integer *l_i1_offset, Integer *k_i1_offset, Integer *size_i1);
  void offset_ccsd_t_vo_5_1_(Integer *l_i1_offset, Integer *k_i1_offset, Integer *size_i1);
  void offset_ccsd_t_vo_6_1_(Integer *l_i1_offset, Integer *k_i1_offset, Integer *size_i1);
}
