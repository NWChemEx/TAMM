...
namespace ctce {
  ...
  void Dummy::construct() {
    std::vector< std::vector<size_t> > vi1; vi1.resize(3);
    ...
    type1_ = t1;
    std::vector< std::vector<size_t> > vi2; vi2.resize(3);
    ...
    std::vector< std::vector<size_t> > vi3; vi3.resize(2);
    ...
    std::vector< std::vector<size_t> > vi4; vi4.resize(1);
