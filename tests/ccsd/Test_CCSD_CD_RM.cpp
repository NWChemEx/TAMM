...
void ccsd_t1(ExecutionContext& ec, const TiledIndexSpace& MO,const TiledIndexSpace& CI, Tensor<T>& i0,
    ...
    sch(i0(p2, h1) = f1(p2, h1));
        ...
        sch
          (_a001(h2, h1) +=  1.0 * t1(p1, h1) * chol3d(h2, p1, cind))
          (_a002()       +=  1.0 * t1(p3, h3) * chol3d(h3, p3, cind))
          (_a003(p1, h1) +=  1.0 * t2(p1, p3, h2, h1) * chol3d(h2, p3, cind))
          (_a004(p2, h2) +=  1.0 * t1(p1, h2) * chol3d(p2, p1, cind))
          (_a005(h2, h1) += -1.0 * _a001(h2, h1) * _a002())
          (_a005(h2, h1) +=  1.0 * _a001(h3, h1) * _a001(h2, h3))
          (_a005(h2, h1) +=  1.0 * chol3d(h3, h1, cind) * _a001(h2, h3))
          (_a005(h2, h1) += -1.0 * chol3d(h2, h1, cind) * _a002())
          (_a005(h2, h1) +=  1.0 * chol3d(h2, p1, cind) * _a003(p1, h1))
          (_a006(p1, h1) +=  1.0 * t1(p1, h1) * _a002())
          (_a006(p3, h1) += -1.0 * t1(p3, h2) * _a001(h2, h1))
          (_a007(h2, p1) +=  1.0 * chol3d(h2, p1, cind) * _a002())
          (_a007(h2, p1) += -1.0 * chol3d(h3, p1, cind) * _a001(h2, h3))
          (i0(p2, h1)    +=  1.0 * t1(p2, h3) * _a005(h3, h1))
          (i0(p2, h1)    +=  1.0 * chol3d(p2, p3, cind) * _a006(p3, h1))
          (i0(p2, h1)    += -1.0 * chol3d(h2, h1, cind) * _a004(p2, h2))
          (i0(p2, h1)    +=  1.0 * chol3d(p2, h1, cind) * _a002())
          (i0(p2, h1)    +=  1.0 * t2(p1, p2, h2, h1) * _a007(h2, p1))
          (i0(p2, h1)    +=  1.0 * chol3d(h3, h1, cind) * _a003(p2, h3))
          (i0(p2, h1)    +=  1.0 * _a003(p2, h3) * _a001(h3, h1))
          (i0(p2, h1)    += -1.0 * chol3d(p2, p1, cind) * _a003(p1, h1));
...
void ccsd_t2(ExecutionContext& ec, const TiledIndexSpace& MO,const TiledIndexSpace& CI, Tensor<T>& i0,
 ...
 //------------------------------CD------------------------------
    ...
    //     Tensor<T>& chol3d = (*(chol.at(x)));
        sch(i0(p3, p4, h1, h2) += 1.0 * chol3d(p3, h1, cind) * chol3d(p4, h2, cind))
            (i0(p3, p4, h1, h2) += -1.0 * chol3d(p3, h2, cind) * chol3d(p4, h1, cind));

        sch (_a3(p3, h1) = 0);
        sch (_a3(p3, h1) += 1.0 * t1(p3, h3) * chol3d(h3, h1, cind))
            (i0_temp(p3, p4, h1, h2) += chol3d(p4, h2, cind) * _a3(p3, h1));
        ...
        sch (_a741(h3, h2) += 1.0 * t1(p1, h2) * chol3d(h3, p1, cind))
        ...
        sch(_a1694(p1, h3, h1, h2) += 1.0 * t2(p1, p2, h1, h2) * chol3d(h3, p2, cind))
            (_a1724(h4, h3, h1, h2) += 1.0 * chol3d(h4, p1, cind) * _a1694(p1, h3, h1, h2))
        ...
        sch (_a1911(h3, p2) += 1.0 * chol3d(h4, p2, cind) * _a741(h3, h4))
            (_a1488(p3, h3, h1, h2) += 1.0 * t2(p2, p3, h1, h2) * _a1911(h3, p2))
            (_a1972() += 1.0 * t1(p1, h4) * chol3d(h4, p1, cind))
            (_a2003(h3, p2) += 1.0 * chol3d(h3, p2, cind) * _a1972())
            (_a1488(p3, h3, h1, h2) += -1.0 * t2(p2, p3, h1, h2) * _a2003(h3, p2));

        sch(_a281(p3, h2) = 0);

        sch(_a281(p3, h2) += 1.0 * t2(p1, p3, h3, h2) * chol3d(h3, p1, cind))
            (i0_temp(p3, p4, h1, h2) += -1.0*_a281(p3, h2) * _a3(p4, h1))
            (_a1488(p3, h4, h1, h2) += -1.0 * chol3d(h3, h1, cind) * _a1694(p3, h4, h3, h2))
            (_a1488(p3, h4, h2, h1) += 1.0 * chol3d(h3, h1, cind) * _a1694(p3, h4, h3, h2)) //perm symm
            ;
   ...
   // }
    ...
    //     Tensor<T> &chol3d = (*(chol.at(x)));
        ...
        sch(_a430(p2, h3, h1, h2) += 1.0 * t2(p1, p2, h1, h2) * chol3d(h3, p1, cind))
            (_a443(p4, h3, h1, h2) += 1.0 * chol3d(p4, p2, cind) * _a430(p2, h3, h1, h2));

        sch(_a16(p4, h2) = 0);
        sch(_a16(p4, h2) += 1.0 * t1(p1, h2) * chol3d(p4, p1, cind))
           (i0_temp(p3, p4, h1, h2) += 1 * chol3d(p3, h1, cind) * _a16(p4, h2));
  //}
    ...
    //     Tensor<T> &chol3d = (*(chol.at(x)));
        ...
        sch(_a1509(h3, h1) += 1.0 * t1(p1, h1) * chol3d(h3, p1, cind))
            (_a1566(h4, h1) += 1.0 * _a1509(h3, h1) * _a1509(h4, h3))
            (_a1602() += 1.0 * t1(p2, h3) * chol3d(h3, p2, cind))
        ...
        sch (_a345(h3, h1) += 1.0 * chol3d(h4, h1, cind) * _a1509(h3, h4))
            (_a357() += 1.0 * t1(p1, h4) * chol3d(h4, p1, cind))
            (_a371(h3, h1) += 1.0 * chol3d(h3, h1, cind) * _a357())

            (_a636(p2, h2) += 1.0 * t2(p1, p2, h4, h2) * chol3d(h4, p1, cind));

        sch(_a482() = 0)
            (_a505(p3, h3, h1, h2) = 0)
            (_a508(p4, h3) = 0);

        sch(_a482() += 1.0 * t1(p2, h3) * chol3d(h3, p2, cind))
            (_a496(p4, p1) += 1.0 * chol3d(p4, p1, cind) * _a482())
            (_a505(p3, h3, h1, h2) += 1.0 * t2(p1, p3, h1, h2) * chol3d(h3, p1, cind))
            (_a508(p4, h3) += 1.0 * t1(p2, h3) * chol3d(p4, p2, cind))
        ...
        sch(_a30(p3, p4, h3, h2) += 1.0 * t2(p3, p4, h3, h4) * chol3d(h4, h2, cind))
           (i0_temp2(p3, p4, h1, h2) = 0)
           (i0_temp2(p3, p4, h1, h2) += 0.5 * chol3d(h3, h1, cind) * _a30(p3, p4, h3, h2));
        sch (_a238(p3, p4, h3, h2) = 0);
        sch (_a238(p3, p4, h3, h2) += 1.0 * t2(p3, p4, h3, h4) * _a1509(h4, h2))            
            (i0_temp2(p3, p4, h1, h2) += 1 * chol3d(h3, h1, cind) * _a238(p3, p4, h3, h2));
        sch (i0_temp2(p3, p4, h1, h2) += 0.5 * _a1509(h4, h1) * _a238(p3, p4, h4, h2))
            ;
    
        sch(_a42(p3, p4, h3, h2) = 0);
    
        sch (_a42(p3, p4, h3, h2) += 1.0 * t2(p1, p3, h3, h2) * chol3d(p4, p1, cind))
            (_a42(p4, p3, h3, h2) += -1.0 * t2(p1, p3, h3, h2) * chol3d(p4, p1, cind)) //perm - why ?
            
            (i0_temp2(p3, p4, h1, h2) += 1.0 * chol3d(h3, h1, cind) * _a42(p3, p4, h3, h2))
            ...
            (i0_temp2(p3, p4, h1, h2) = 0)
            (i0_temp2(p3, p4, h1, h2) += -1.0 * chol3d(p4, h1, cind) * _a636(p3, h2));
        ...
        sch (_a385(p1, p3, h2, h1) += 1.0 * t2(p1, p3, h3, h2) * _a1509(h3, h1))
            ...
            (i0(p3, p4, h1, h2) += 1.0 * chol3d(p4, p1, cind) * _a385(p1, p3, h2, h1))
            (i0(p4, p3, h1, h2) += -1.0 * chol3d(p4, p1, cind) * _a385(p1, p3, h2, h1)) //perm symm
            (_a408(p4, h1) += 1.0 * t1(p2, h1) * chol3d(p4, p2, cind))
        ...
        sch(_a119(p4, h2) += 1.0 * t1(p1, h2) * chol3d(p4, p1, cind))
            (_a116(p3, h1) += 1.0 * t1(p3, h3) * chol3d(h3, h1, cind))
            (_a146(p3, h2) += 1.0 * t1(p3, h3) * _a1509(h3, h2))
            
            (i0_temp2(p3, p4, h1, h2) += -1.0 * _a116(p3, h1) * _a119(p4, h2))
            (i0_temp2(p3, p4, h1, h2) += 1.0 * chol3d(p4, h1, cind) * _a146(p3, h2))
...
//------------------------------------------------------------------------
    ...
    //     Tensor<T> &chol3d = (*(chol.at(x)));
        ...
        sch(_a54(p1, p4, h1, h2) += 1.0 * t2(p1, p2, h1, h2) * chol3d(p4, p2, cind))
            (i0(p3, p4, h1, h2) += 0.5 * chol3d(p3, p1, cind) * _a54(p1, p4, h1, h2)) //factor 0.25->0.5
            (i0(p4, p3, h1, h2) += -0.5 * chol3d(p3, p1, cind) * _a54(p1, p4, h1, h2)); //perm symm
    //}
...
template<typename T>
void ccsd_driver(ExecutionContext* ec, const TiledIndexSpace& MO, const TiledIndexSpace& CI,
...
//   ec->pg().barrier();
  ...
  for(int titer = 0; titer < maxiter; titer += ndiis) {
      for(int iter = titer; iter < std::min(titer + ndiis, maxiter); iter++) {
          ...
          ccsd_t1(*ec, MO, CI, d_r1, d_t1, d_t2, d_f1, d_v2, chol, cv3d);
          ccsd_t2(*ec, MO, CI, d_r2, d_t1, d_t2, d_f1, d_v2, chol, cv3d);
...
TEST_CASE("CCSD Driver") {
  ...
  CHECK_NOTHROW(ccsd_driver<T>(ec, MO, CV, d_t1, d_t2, d_f1, d_v2, chol_vecs,
                               ...
                               total_orbitals, 2 * ov_alpha, CV3D));
