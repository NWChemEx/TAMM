...
template<typename T>
void eomccsd_y1(ExecutionContext& ec, const TiledIndexSpace& MO,
   ...
   auto [h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12] = MO.labels<11>("occ");
   auto [p1, p3, p4, p5, p7, p8, p9, p10] = MO.labels<8>("virt");
   ...
   Tensor<T> i_6      {{O,O},{1,1}};
   Tensor<T> i_7      {{O,O},{1,1}};
   Tensor<T> i_8      {{V,V},{1,1}};
   Tensor<T> i_9      {{O,O,O,V},{2,2}};
   Tensor<T> i_10     {{V,O},{1,1}};
   Tensor<T> i_10_1   {{O,O},{1,1}};
   Tensor<T> i_10_2   {{O,O,O,V},{2,2}};
   ...
   Tensor<T> i_13_1   {{O,O,O,V},{2,2}};
    ...
    sch
      .allocate(i_1,i_1_1,i_2,i_2_1,i_3,i_3_1,i_3_1_1,i_3_2,i_3_3,i_3_4,i_4,i_4_1,i_4_1_1,
                i_4_2,i_4_3,i_4_4,i_5,i_6,i_7,i_8,i_9,i_10,i_10_1,i_10_2,i_11,i_11_1,
                i_11_1_1,i_11_2,i_11_3,i_12,i_12_1,i_13,i_13_1)
      ( i0(h2,p1)                     =  0                                                  )
      (   i_1(h2,h7)                 +=         f1(h2,h7)                                   )
      ...
      (     i_4_1(h2,h7,h11,h12)     += -2.0  * t1(p3,h11)         * i_4_1_1(h2,h7,h12,p3)  )
      ...
      (   i_6(h2,h3)                 +=         t1(p4,h3)          * y1(h2,p4)              )
      (   i_6(h2,h3)                 +=  0.5  * t2(p4,p5,h3,h6)    * y2(h2,h6,p4,p5)        )
      ( i0(h2,p1)                    += -1    * i_6(h2,h3)         * f1(h3,p1)              )
      (   i_7(h6,h8)                 +=         t1(p3,h8)          * y1(h6,p3)              )
      (   i_7(h6,h8)                 +=  0.5  * t2(p3,p4,h5,h8)    * y2(h5,h6,p3,p4)        )
      ( i0(h2,p1)                    +=         i_7(h6,h8)         * v2(h2,h8,h6,p1)        )
      (   i_8(p7,p8)                 +=         t1(p7,h4)          * y1(h4,p8)              )
      (   i_8(p7,p8)                 +=  0.5  * t2(p3,p7,h5,h6)    * y2(h5,h6,p3,p8)        )
      ( i0(h2,p1)                    +=         i_8(p7,p8)         * v2(h2,p8,p1,p7)        )
      (   i_9(h2,h6,h4,p5)           +=         t1(p3,h4)          * y2(h2,h6,p3,p5)        )
      ( i0(h2,p1)                    +=         i_9(h2,h6,h4,p5)   * v2(h4,p5,h6,p1)        )
      (   i_10(p10,h9)               +=         t2(p3,p10,h5,h9)   * y1(h5,p3)              )
      (     i_10_1(h6,h9)            +=         t1(p5,h9)          * y1(h6,p5)              )
      (     i_10_1(h6,h9)            +=  0.5  * t2(p3,p4,h5,h9)    * y2(h5,h6,p3,p4)        )
      (   i_10(p10,h9)               += -1    * t1(p10,h6)         * i_10_1(h6,h9)          )
      (     i_10_2(h5,h6,h9,p3)      +=         t1(p7,h9)          * y2(h5,h6,p3,p7)        )
      (   i_10(p10,h9)               += -0.5  * t2(p3,p10,h5,h6)   * i_10_2(h5,h6,h9,p3)    )
      ( i0(h2,p1)                    +=         i_10(p10,h9)       * v2(h2,h9,p1,p10)       )
      ...
      (     i_11_1(h2,h10,h6,h12)    +=  2.0  * t1(p5,h12)         * i_11_1_1(h2,h10,h6,p5) )
      (   i_11(h2,p9,h6,h12)         += -0.5  * t1(p9,h10)         * i_11_1(h2,h10,h6,h12)  )
      (     i_11_2(h2,h5,h6,p3)      +=         t1(p7,h6)          * y2(h2,h5,p3,p7)        )
      (   i_11(h2,p9,h6,h12)         +=  2.0  * t2(p3,p9,h5,h12)   * i_11_2(h2,h5,h6,p3)    )
      ...
      (   i_12(h2,h7,h6,h8)          +=  2.0  * t1(p3,h8)          * i_12_1(h2,h7,h6,p3)    )
      ...
      .deallocate(i_1,i_1_1,i_2,i_2_1,i_3,i_3_1,i_3_1_1,i_3_2,i_3_3,i_3_4,i_4,i_4_1,i_4_1_1,
                  i_4_2,i_4_3,i_4_4,i_5,i_6,i_7,i_8,i_9,i_10,i_10_1,i_10_2,i_11,i_11_1,
                  i_11_1_1,i_11_2,i_11_3,i_12,i_12_1,i_13,i_13_1).execute();
}

template<typename T>
void eomccsd_y2(ExecutionContext& ec, const TiledIndexSpace& MO,
               Tensor<T>& i0, const Tensor<T>& t1, const Tensor<T>& t2,
               const Tensor<T>& y1, const Tensor<T>& y2,
               const Tensor<T>& f1, const Tensor<T>& v2) {
   ...
   auto [h3, h4, h5, h6, h7, h8, h9, h10] = MO.labels<8>("occ");
   auto [p1, p2, p5, p6, p7, p10] = MO.labels<6>("virt");
   ...
   sch
     .allocate(i_1,i_2,i_3,i_3_1,i_4,i_4_1,i_5,i_5_1,i_6,i_7,i_8,i_9,i_10,
               i_11,i_12,i_12_1,i_13_1,i_13)
     ( i0(h3,h4,p1,p2)          =  0                                              )
     (   i_1(h3,p1)            +=         f1(h3,p1)                               )
     (   i_1(h3,p1)            +=         t1(p5,h6)         * v2(h3,h6,p1,p5)     )
     ( i0(h3,h4,p1,p2)         +=         y1(h3,p1)         * i_1(h4,p2)          )
     ( i0(h3,h4,p1,p2)         += -1    * y1(h3,p2)         * i_1(h4,p1)          ) //P(p1/p2)
     ( i0(h3,h4,p1,p2)         += -1    * y1(h4,p1)         * i_1(h3,p2)          ) //P(h3/h4)
     ( i0(h3,h4,p1,p2)         +=         y1(h4,p2)         * i_1(h3,p1)          ) //P(p1/p2,h3/h4)
     (   i_2(h3,h4,h7,p1)      +=         v2(h3,h4,h7,p1)                         )
     (   i_2(h3,h4,h7,p1)      += -1    * t1(p5,h7)         * v2(h3,h4,p1,p5)     )
     ( i0(h3,h4,p1,p2)         += -1    * y1(h7,p1)         * i_2(h3,h4,h7,p2)    )
     ( i0(h3,h4,p1,p2)         +=         y1(h7,p2)         * i_2(h3,h4,h7,p1)    ) //P(p1/p2)
     ( i0(h3,h4,p1,p2)         += -1    * y1(h3,p5)         * v2(h4,p5,p1,p2)     )
     ( i0(h3,h4,p1,p2)         +=         y1(h4,p5)         * v2(h3,p5,p1,p2)     ) //P(h3/h4)
     (   i_3(h3,h9)            +=         f1(h3,h9)                               )
     ...
     ( i0(h3,h4,p1,p2)         +=         y2(h4,h9,p1,p2)   * i_3(h3,h9)          ) //P(h3/h4)
     ...
     ( i0(h3,h4,p1,p2)         +=         y2(h3,h9,p2,p7)   * i_6(h4,p7,h9,p1)    ) //P(p1/p2)
     ( i0(h3,h4,p1,p2)         +=         y2(h4,h9,p1,p7)   * i_6(h3,p7,h9,p2)    ) //P(h3/h4)
     ( i0(h3,h4,p1,p2)         += -1    * y2(h4,h9,p2,p7)   * i_6(h3,p7,h9,p1)    ) //P(p1/p2,h3/h4)
     ...
     ( i0(h3,h4,p1,p2)         += -1    * i_7(h4,h9)        * v2(h3,h9,p1,p2)     ) //P(h3/h4)
     (   i_8(h3,h4,h5,p1)      += -1    * t1(p6,h5)         * y2(h3,h4,p1,p6)     )
     ( i0(h3,h4,p1,p2)         +=         i_8(h3,h4,h5,p1)  * f1(h5,p2)           )
     ( i0(h3,h4,p1,p2)         += -1    * i_8(h3,h4,h5,p2)  * f1(h5,p1)           ) //P(p1/p2)
     (   i_9(h3,h7,h6,p1)      +=         t1(p5,h6)         * y2(h3,h7,p1,p5)     )
     ( i0(h3,h4,p1,p2)         +=         i_9(h3,h7,h6,p1)  * v2(h4,h6,h7,p2)     )
     ( i0(h3,h4,p1,p2)         += -1    * i_9(h3,h7,h6,p2)  * v2(h4,h6,h7,p1)     ) //P(p1/p2)
     ( i0(h3,h4,p1,p2)         += -1    * i_9(h4,h7,h6,p1)  * v2(h3,h6,h7,p2)     ) //P(h3/h4)
     ( i0(h3,h4,p1,p2)         +=         i_9(h4,h7,h6,p2)  * v2(h3,h6,h7,p1)     ) //P(p1/p2,h3/h4)
     ...
     ( i0(h3,h4,p1,p2)         +=  0.5  * i_11(p6,p2)       * v2(h3,h4,p1,p6)     ) //P(p1/p2)
     (   i_12(h3,h4,h8,h9)     +=         t2(p5,p6,h8,h9)   * y2(h3,h4,p5,p6)     )
     (     i_12_1(h3,h4,h8,p5) += -1    * t1(p7,h8)         * y2(h3,h4,p5,p7)     )
     (   i_12(h3,h4,h8,h9)     +=  2.0  * t1(p5,h9)         * i_12_1(h3,h4,h8,p5) )
     ...
     ( i0(h3,h4,p1,p2)         +=         i_13(h3,p5,h8,p2) * v2(h4,h8,p1,p5)     ) //P(p1/p2)
     ( i0(h3,h4,p1,p2)         +=         i_13(h4,p5,h8,p1) * v2(h3,h8,p2,p5)     ) //P(h3/h4)
     ( i0(h3,h4,p1,p2)         += -1    * i_13(h4,p5,h8,p2) * v2(h3,h8,p1,p5)     ) //P(p1/p2,h3/h4)
     .deallocate(i_1,i_2,i_3,i_3_1,i_4,i_4_1,i_5,i_5_1,i_6,i_7,i_8,i_9,i_10,
                 i_11,i_12,i_12_1,i_13_1,i_13).execute();
}
...
void eomccsd_driver(ExecutionContext& ec, const TiledIndexSpace& MO,
  ...
  auto populate_vector_of_tensors = [&] (std::vector<Tensor<T>> &vec, bool is2D=true){
      for(auto x=0;x<vec.size();x++){
         if(is2D) vec[x] = Tensor<T>{{O,V},{1,1}};
         else     vec[x] = Tensor<T>{{O,O,V,V},{2,2}};
...
//       MICROCYCLE AND (NROOTS*MICROEOMITER) FOR THE REMAINING.
  ...
  Tensor<T> uu2{{O, O, V, V},{2,2}};
  Tensor<T> uuu2{{O, O, V, V},{2,2}};
  Tensor<T>::allocate(&ec,u1,u2,uu2,uuu2);

  using std::vector;

  vector<Tensor<T>> y1(hbardim);
  populate_vector_of_tensors(y1);
  vector<Tensor<T>> y2(hbardim);
  populate_vector_of_tensors(y2,false);
  vector<Tensor<T>> yp1(hbardim);
  populate_vector_of_tensors(yp1);
  vector<Tensor<T>> yp2(hbardim);
  populate_vector_of_tensors(yp2,false);
  vector<Tensor<T>> yc1(nroots);
  populate_vector_of_tensors(yc1);
  vector<Tensor<T>> yc2(nroots);
  populate_vector_of_tensors(yc2,false);
...
//################################################################################
  ...
  eom_guess(nroots,noab,p_evl_sorted,y1,true);
...
//################################################################################
  ...
  if(ec.pg().rank() == 0){
    std::cout << "\n\n";
    std::cout << " No. of initial left vectors " << ninitvecs << std::endl;
    std::cout << "\n";
    std::cout << " EOM-CCSD left-hand side iterations" << std::endl;
  ...
  for(int iter = 0; iter < maxeomiter;){
     ...
     for(int micro = 0; micro < microeomiter; iter++, micro++){
        ...
        for(int root= nxtrials; root < newnxtrials; root++){
           ...
           eomccsd_y1(ec, MO, yp1.at(root), t1, t2, y1.at(root), y2.at(root), f1, v2);
           eomccsd_y2(ec, MO, yp2.at(root), t1, t2, y1.at(root), y2.at(root), f1, v2);

        }

//################################################################################
//  UPDATE HBAR: ELEMENTS FOR THE NEWEST Y AND YP VECTORS ARE COMPUTED
//################################################################################
...
//################################################################################
           if(xresidual > eomthresh){
             ...
             if(newnxtrials <= hbardim){
               ...
               jacobi(ec, r1.at(root), u1, 0.0, true, p_evl_sorted, noab);
               jacobi(ec, r2.at(root), u2, 0.0, true, p_evl_sorted, noab);

               sch(y1.at(ivec)() = newsc * u1())
                  (y2.at(ivec)() = newsc * u2()).execute();
               ...
               for(int jvec = 0; jvec<ivec; jvec++){
                  ...
                  sch(u1() += -1 * tmps * y1.at(jvec)())
                     (u2() += -1 * tmps * y2.at(jvec)()).execute();
               }
...
//################################################################################
  ...
  for(auto root = 0; root < nroots; root++){
     ...
     sch(y1.at(root)() = yc1.at(root)())
        (y2.at(root)() = yc2.at(root)()).execute();
  ...
  free_vec_tensors(y1, y2, yp1, yp2, yc1, yc2, r1, r2);
...
//    double y2guessthresh = 0.6; //THRESHOLD FOR X2 INITIAL GUESS (LATER IMPLEMENTATION)
    size_t microeomiter  = 50; //Number of iterations in a microcycle
