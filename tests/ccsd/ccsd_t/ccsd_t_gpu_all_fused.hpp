...
void ccsd_t_gpu_all_fused(ExecutionContext& ec,
    ...
    size_t max_dima = abuf_size1 / noab;
    size_t max_dimb = bbuf_size1 / noab;
    size_t max_dima2 = abuf_size2 / nvab;
    size_t max_dimb2 = bbuf_size2 / nvab;
