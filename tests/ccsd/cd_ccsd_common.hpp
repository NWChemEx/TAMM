...
Tensor<double> r1_aa, r1_bb; //r2_aaaa, r2_abab, r2_bbbb, r2_baba, r2_abba, r2_baab;
...
void ccsd_e(/* ExecutionContext &ec, */
    ...
    Tensor<T> _a02_aa{o_alpha,o_alpha,CI}, _a02_bb{o_beta,o_beta,CI};
    Tensor<T> _a03_aa{o_alpha,v_alpha,CI}, _a03_bb{o_beta,v_beta,CI};
...
void ccsd_t1(/* ExecutionContext& ec,  */
    ...
    Tensor<T> _a01_aa{o_alpha,o_alpha,CI}, _a01_bb{o_beta,o_beta,CI};
    Tensor<T> _a03_aa{v_alpha,o_alpha,CI}, _a03_bb{v_beta,o_beta,CI};

    Tensor<T> _a04_aa{o_alpha,o_alpha}, _a04_bb{o_beta,o_beta};
    Tensor<T> _a05_aa{o_alpha,v_alpha}, _a05_bb{o_beta,v_beta};
    ...
    sch.allocate(_a02, _a01_aa,_a01_bb,_a03_aa,_a03_bb,_a04_aa,_a04_bb,_a05_aa,_a05_bb);
     sch(i0_aa(p2_va, h1_oa)  = f1_aa_vo(p2_va, h1_oa))
...
void ccsd_t2(/* ExecutionContext& ec, */
    ...
    Tensor<T> _a007{CI};
    Tensor<T> _a017_aa{v_alpha,o_alpha,CI};
    Tensor<T> _a017_bb{v_beta,o_beta,CI};
    Tensor<T> _a006_aa{o_alpha,o_alpha};
    Tensor<T> _a006_bb{o_beta,o_beta};
    Tensor<T> _a009_aa{o_alpha,o_alpha,CI};
    Tensor<T> _a009_bb{o_beta,o_beta,CI};
    Tensor<T> _a021_aa{v_alpha,v_alpha,CI};
    Tensor<T> _a021_bb{v_beta,v_beta,CI};
    Tensor<T> _a008_aa{o_alpha,o_alpha,CI};
    Tensor<T> _a008_bb{o_beta,o_beta,CI};
    Tensor<T> _a001_aa{v_alpha,v_alpha};
    Tensor<T> _a001_bb{v_beta,v_beta};

    Tensor<T> _a019_aaaa{o_alpha,o_alpha,o_alpha,o_alpha};
    Tensor<T> _a019_abab{o_alpha,o_beta,o_alpha,o_beta};
    Tensor<T> _a019_bbbb{o_beta,o_beta,o_beta,o_beta};
    Tensor<T> _a019_abba{o_alpha,o_beta,o_beta,o_alpha};
    Tensor<T> _a019_baab{o_beta,o_alpha,o_alpha,o_beta};
    Tensor<T> _a019_baba{o_beta,o_alpha,o_beta,o_alpha};
    
    Tensor<T> _a020_aaaa{v_alpha,o_alpha,v_alpha,o_alpha};
    Tensor<T> _a020_abab{v_alpha,o_beta,v_alpha,o_beta};
    Tensor<T> _a020_baab{v_beta,o_alpha,v_alpha,o_beta};
    Tensor<T> _a020_abba{v_alpha,o_beta,v_beta,o_alpha};

    Tensor<T> _a020_baba{v_beta,o_alpha,v_beta,o_alpha};
    Tensor<T> _a020_bbbb{v_beta,o_beta,v_beta,o_beta};
    Tensor<T> _a022_aaaa{v_alpha,v_alpha,v_alpha,v_alpha};
    Tensor<T> _a022_abab{v_alpha,v_beta,v_alpha,v_beta};
    Tensor<T> _a022_baba{v_beta,v_alpha,v_beta,v_alpha};
    Tensor<T> _a022_bbbb{v_beta,v_beta,v_beta,v_beta};

    // Tensor<T> i0_aaaa = r2_aaaa;
    // Tensor<T> i0_abab = r2_abab;
    // Tensor<T> i0_bbbb = r2_bbbb;

    // Tensor<T> i0_baba = r2_baba;
    // Tensor<T> i0_abba = r2_abba;
    // Tensor<T> i0_baab = r2_baab;
 ...
 //------------------------------CD------------------------------
    ...
    sch.allocate(_a007,_a001_aa,_a001_bb,_a017_aa,_a017_bb,
        ...
        _a008_bb,_a019_aaaa,_a019_abab,_a019_abba,_a019_baab,_a019_baba,_a019_bbbb,_a020_aaaa,_a020_baba,
        _a020_abab,_a020_baab,_a020_bbbb,_a020_abba,_a022_aaaa,_a022_abab,_a022_baba,_a022_bbbb
        );
    ...
    sch
        ...
        (i0(p3_va, p4_va, h1_oa, h2_oa) +=  0.5 * _a017_aa(p3_va, h1_oa, cind) * _a017_aa(p4_va, h2_oa, cind))
        (i0(p3_vb, p4_vb, h1_ob, h2_ob) +=  0.5 * _a017_bb(p3_vb, h1_ob, cind) * _a017_bb(p4_vb, h2_ob, cind))
    ...
    sch 
        ...
        (_a022_baba(p3_vb,p4_va,p2_vb,p1_va) = _a022_abab(p4_va,p3_vb,p1_va,p2_vb)) 
        (_a022_bbbb(p3_vb,p4_vb,p2_vb,p1_vb) = _a021_bb(p3_vb,p2_vb,cind) * _a021_bb(p4_vb,p1_vb,cind))

        (i0(p3_va, p4_va, h1_oa, h2_oa)  +=  1.0 * _a022_aaaa(p3_va, p4_va, p2_va, p1_va) * t2_aaaa(p2_va,p1_va,h1_oa,h2_oa))
        (i0(p3_vb, p4_vb, h1_ob, h2_ob)  +=  1.0 * _a022_bbbb(p3_vb, p4_vb, p2_vb, p1_vb) * t2_bbbb(p2_vb,p1_vb,h1_ob,h2_ob))
        
        (i0(p3_va, p4_vb, h1_oa, h2_ob)  +=  2.0 * _a022_abab(p3_va, p4_vb, p2_va, p1_vb) * t2_abab(p2_va,p1_vb,h1_oa,h2_ob))
        (i0(p3_va, p4_vb, h1_oa, h2_ob)  +=  2.0 * _a022_abab(p3_va, p4_vb, p2_va, p1_vb) * t2_abab(p2_va,p1_vb,h1_oa,h2_ob))
        
        (_a019_aaaa(h4_oa, h3_oa, h1_oa, h2_oa) += -0.125 * _a004_aaaa(p1_va, p2_va, h3_oa, h4_oa) * t2_aaaa(p1_va,p2_va,h1_oa,h2_oa))
        (_a019_baab(h4_ob, h3_oa, h1_oa, h2_ob)  = -0.125 * _a004_abab(p1_va, p2_vb, h3_oa, h4_ob) * t2_abab(p1_va,p2_vb,h1_oa,h2_ob))    
        ...
        (i0(p3_va, p4_va, h1_oa, h2_oa) +=  1.0 * _a019_aaaa(h4_oa, h3_oa, h1_oa, h2_oa) * t2_aaaa(p3_va, p4_va, h4_oa, h3_oa))
        (i0(p3_vb, p4_vb, h1_ob, h2_ob) +=  1.0 * _a019_bbbb(h4_ob, h3_ob, h1_ob, h2_ob) * t2_bbbb(p3_vb, p4_vb, h4_ob, h3_ob))
        
        (i0(p3_va, p4_vb, h1_oa, h2_ob) +=  1.0 * _a019_abab(h4_oa, h3_ob, h1_oa, h2_ob) * t2_abab(p3_va, p4_vb, h4_oa, h3_ob))
        (i0(p4_va, p3_vb, h2_oa, h1_ob) +=  1.0 * _a019_abab(h3_oa, h4_ob, h2_oa, h1_ob) * t2_abab(p4_va, p3_vb, h3_oa, h4_ob))
        (i0(p3_va, p4_vb, h2_oa, h1_ob) +=  1.0 * _a019_abab(h3_oa, h4_ob, h2_oa, h1_ob) * t2_abab(p3_va, p4_vb, h3_oa, h4_ob))
        (i0(p4_va, p3_vb, h1_oa, h2_ob) +=  1.0 * _a019_abab(h4_oa, h3_ob, h1_oa, h2_ob) * t2_abab(p4_va, p3_vb, h4_oa, h3_ob))
        ...
        (i0(p3_va, p4_va, h1_oa, h2_oa) +=  1.0 * _a020_aaaa(p4_va, h4_oa, p1_va, h1_oa) * t2_aaaa(p3_va, p1_va, h4_oa, h2_oa))
        (i0(p3_va, p4_va, h1_oa, h2_oa) += -1.0 * _a020_abba(p4_va, h4_ob, p1_vb, h1_oa) * t2_abab(p3_va, p1_vb, h2_oa, h4_ob))
        (i0(p3_vb, p4_vb, h1_ob, h2_ob) +=  1.0 * _a020_bbbb(p4_vb, h4_ob, p1_vb, h1_ob) * t2_bbbb(p3_vb, p1_vb, h4_ob, h2_ob))
        (i0(p3_vb, p4_vb, h1_ob, h2_ob) += -1.0 * _a020_baab(p4_vb, h4_oa, p1_va, h1_ob) * t2_abab(p1_va, p3_vb, h4_oa, h2_ob))
    ...
    sch
        ...
        (i0(p3_va, p4_va, h1_oa, h2_oa) += -0.5 * t2_aaaa(p3_va, p2_va, h1_oa, h2_oa) * _a001_aa(p4_va, p2_va))
        (i0(p3_vb, p4_vb, h1_ob, h2_ob) += -0.5 * t2_bbbb(p3_vb, p2_vb, h1_ob, h2_ob) * _a001_bb(p4_vb, p2_vb))
        ...
        (i0(p3_va, p4_va, h2_oa, h1_oa) += -0.5 * t2_aaaa(p3_va, p4_va, h3_oa, h1_oa) * _a006_aa(h3_oa, h2_oa))
        (i0(p3_vb, p4_vb, h2_ob, h1_ob) += -0.5 * t2_bbbb(p3_vb, p4_vb, h3_ob, h1_ob) * _a006_bb(h3_ob, h2_ob))
        ...
        (i0(p3_va, p4_va, h1_oa, h2_oa) +=  1.0 * i0(p4_va, p3_va, h2_oa, h1_oa))    
        (i0(p3_va, p4_va, h1_oa, h2_oa) += -1.0 * i0(p3_va, p4_va, h2_oa, h1_oa))
        (i0(p3_vb, p4_vb, h1_ob, h2_ob) +=  1.0 * i0(p4_vb, p3_vb, h2_ob, h1_ob))    
        (i0(p3_vb, p4_vb, h1_ob, h2_ob) += -1.0 * i0(p3_vb, p4_vb, h2_ob, h1_ob))
        ;
...
std::tuple<double,double> cd_ccsd_driver(ExecutionContext& ec, const TiledIndexSpace& MO,
    ...
    t1_aa = {v_alpha,o_alpha}; 
    t1_bb = {v_beta,o_beta};
    t2_aaaa = {v_alpha,v_alpha,o_alpha,o_alpha};
    t2_abab = {v_alpha,v_beta,o_alpha,o_beta};
    t2_bbbb = {v_beta,v_beta,o_beta,o_beta};

    _a004_aaaa = {v_alpha,v_alpha,o_alpha,o_alpha};
    _a004_abab = {v_alpha,v_beta,o_alpha,o_beta};
    _a004_bbbb = {v_beta,v_beta,o_beta,o_beta};

    f1_aa_oo = {o_alpha,o_alpha};
    f1_aa_ov = {o_alpha,v_alpha};
    f1_aa_vo = {v_alpha,o_alpha};
    f1_aa_vv = {v_alpha,v_alpha};

    f1_bb_oo = {o_beta,o_beta};
    f1_bb_ov = {o_beta,v_beta};
    f1_bb_vo = {v_beta,o_beta};
    f1_bb_vv = {v_beta,v_beta};

    chol3d_aa_oo = {o_alpha,o_alpha,CI};
    chol3d_aa_ov = {o_alpha,v_alpha,CI};
    chol3d_aa_vo = {v_alpha,o_alpha,CI};
    chol3d_aa_vv = {v_alpha,v_alpha,CI};

    chol3d_bb_oo = {o_beta,o_beta,CI};
    chol3d_bb_ov = {o_beta,v_beta,CI};
    chol3d_bb_vo = {v_beta,o_beta,CI};
    chol3d_bb_vv = {v_beta,v_beta,CI};

    r1_aa = {v_alpha,o_alpha}; 
    r1_bb = {v_beta,o_beta};

    // r2_aaaa = {v_alpha,v_alpha,o_alpha,o_alpha};
    // r2_abab = {v_alpha,v_beta,o_alpha,o_beta};
    // r2_bbbb = {v_beta,v_beta,o_beta,o_beta};
    ...
    sch.allocate(t1_aa, t1_bb, t2_aaaa, t2_abab, t2_bbbb, r1_aa, r1_bb, 
                //r2_aaaa, r2_abab, r2_bbbb,   r2_baba, r2_abba, r2_baab,
