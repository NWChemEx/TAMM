...
extern "C" {
  ...
  void ipccsd_x1_1_2_1_(Integer *d_f, Integer *k_f_offset,Integer *d_x1_1_2_1, Integer *k_x1_1_2_1_offset);
  void ipccsd_x1_1_2_2_(Integer *d_t_vo, Integer *k_t_vo_offset,Integer *d_v, Integer *k_v_offset,Integer *d_x1_1_2_1, Integer *k_x1_1_2_1_offset);
  void ipccsd_x1_1_2_(Integer *d_t_vo, Integer *k_t_vo_offset,Integer *d_x1_1_2_1, Integer *k_x1_1_2_1_offset,Integer *d_x1_1_1, Integer *k_x1_1_1_offset);
  ...
  void ipccsd_x1_3_(Integer *d_x_voo, Integer *k_x_voo_offset,Integer *d_x1_3_1, Integer *k_x1_3_1_offset,Integer *d_i0, Integer *k_i0_offset);

  void offset_ipccsd_x1_1_1_(Integer *l_x1_1_1_offset, Integer *k_x1_1_1_offset, Integer *size_x1_1_1);
  void offset_ipccsd_x1_1_2_1_(Integer *l_x1_1_2_1_offset, Integer *k_x1_1_2_1_offset, Integer *size_x1_1_2_1);
...
extern "C" {
  void ipccsd_x1_cxx_(Integer *d_t_vvoo, Integer *d_f, Integer *d_x_voo, Integer *d_x_o, Integer *d_v, Integer *d_t_vo, Integer *d_i0, 
  ...
  v->attach(*k_v_offset, 0, *d_v);
    ...
    CorFortran(1, op_x1_3, ipccsd_x1_3_);
    destroy(x1_3_1);
  #endif
