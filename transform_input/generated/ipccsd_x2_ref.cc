...
extern "C" {
  void ipccsd_x2_cxx_(Integer *d_t_vvoo, Integer *d_f, Integer *d_x_voo, Integer *d_x_o, Integer *d_v, Integer *d_t_vo, Integer *d_i0, 
  Integer *k_t_vvoo_offset, Integer *k_f_offset, Integer *k_x_voo_offset, Integer *k_x_o_offset, Integer *k_v_offset, Integer *k_t_vo_offset, Integer *k_i0_offset) {
  ...
  v->attach(*k_v_offset, 0, *d_v);
    ...
    destroy(x2_5_1);
    CorFortran(1, op_x2_6_1_1, ofsset_ipccsd_x2_6_1_1_);
    CorFortran(1, op_x2_6_1_1, ipccsd_x2_6_1_1_);
    CorFortran(1, op_x2_6_1_2_1, ofsset_ipccsd_x2_6_1_2_1_);
